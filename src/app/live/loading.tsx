      ...
      <nav className="sticky top-0 z-50 border-b border-gray-800 bg-[#0A0F1E]/95 backdrop-blur-sm">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          ...
          <div className="space-x-8 text-sm font-medium">
            ...
            <Link href="/live" className="text-white transition">
              Live
            </Link>
          </div>
        </div>
      ...
      <main className="mx-auto max-w-7xl px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            <div className="bg-[#111827] rounded-xl border border-gray-800 p-6 animate-pulse">
          ...
          <div className="lg:col-span-3">
            <div className="bg-[#111827] rounded-xl border border-gray-800 p-6 animate-pulse">
              ...
              <div className="space-y-4">
                {[...Array(3)].map((_, i) => (
                  <div key={i} className="border-l-4 border-gray-700 pl-4 py-2">
