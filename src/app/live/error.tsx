    ...
    <div className="min-h-screen bg-[#F9FAFB] text-[#111827]">
      <nav className="bg-[#1E3A8A] text-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          ...
          <div className="space-x-6">
            ...
            <Link href="/speakers" className="transition-colors hover:text-[#14B8A6]">
              Speakers
            </Link>
            <Link href="/live" className="text-[#14B8A6] font-semibold">
              Live
            </Link>
          </div>
        </div>
      ...
      <main className="mx-auto max-w-7xl px-4 py-12 text-center">
        <div className="bg-white rounded-xl shadow-md p-8 max-w-md mx-auto">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Failed to load live data</h2>
          <p className="text-[#6B7280] mb-6">We couldn't load the live dashboard. Please try again.</p>
          <button
            onClick={reset}
